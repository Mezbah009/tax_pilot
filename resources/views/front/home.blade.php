        ...
        <div class="hero-section hs-3">
            <div class="hero-single">
                <div class="hero-shape-1">
                    <img src="{{ asset('front-assets/assets/img/hero/bg.jpg') }}" alt="">
                </div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-lg-6">
                            <div class="hero-content">
                                ...
                                <h1 class="hero-title wow fadeInRight" data-wow-delay=".50s">
                                    We Help You To <span>Avoid</span> Tax Blunders
                                </h1>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="hero-img-wrap wow fadeInRight" data-wow-delay=".25s">
                                <div class="hero-img">
                                    <img src="{{ asset('front-assets/assets/img/hero/02.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="about-right wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="about-list-wrap">
                                <ul class="about-list">
                                    <li>
                                        <div class="icon">
                                            <img src="{{ asset('front-assets/assets/img/icon/rating-2.svg') }}" alt="">
                                        </div>
                                        <div class="content">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item cat1 cat2">
                        <div class="case-item">
                            <div class="case-img">
                                ...
                                <img class="img-fluid" src="{{ asset('front-assets/assets/img/case/01.jpg') }}" alt="">
                                <div class="case-btn">
                        ...
                        <div class="case-item">
                            <div class="case-img">
                                <a class="popup-img case-link" href="{{ asset('front-assets/assets/img/case/02.jpg') }}"> <i
                                    class="fal fa-plus"></i></a>
                                <img class="img-fluid" src="{{ asset('front-assets/assets/img/case/02.jpg') }}" alt="">
                                <div class="case-btn">
                                    <a href="case-study-single.html"><i class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="case-item">
                            <div class="case-img">
                                <a class="popup-img case-link" href="{{ asset('front-assets/assets/img/case/03.jpg') }}"> <i
                                    class="fal fa-plus"></i></a>
                                <img class="img-fluid" src="{{ asset('front-assets/assets/img/case/03.jpg') }}" alt="">
                                <div class="case-btn">
                                    <a href="case-study-single.html"><i class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="case-item">
                            <div class="case-img">
                                <a class="popup-img case-link" href="{{ asset('front-assets/assets/img/case/04.jpg') }}"> <i
                                    class="fal fa-plus"></i></a>
                                <img class="img-fluid" src="{{ asset('front-assets/assets/img/case/04.jpg') }}" alt="">
                                <div class="case-btn">
                                    <a href="case-study-single.html"><i class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="case-item">
                            <div class="case-img">
                                <a class="popup-img case-link" href="{{ asset('front-assets/assets/img/case/05.jpg') }}"> <i
                                    class="fal fa-plus"></i></a>
                                <img class="img-fluid" src="{{ asset('front-assets/assets/img/case/05.jpg') }}" alt="">
                                <div class="case-btn">
                                    <a href="case-study-single.html"><i class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="case-item">
                            <div class="case-img">
                                <a class="popup-img case-link" href="{{ asset('front-assets/assets/img/case/06.jpg') }}"> <i
                                    class="fal fa-plus"></i></a>
                                <img class="img-fluid" src="{{ asset('front-assets/assets/img/case/06.jpg') }}" alt="">
                                <div class="case-btn">
                                    <a href="case-study-single.html"><i class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
        ...
        <div class="video-area">
            <div class="container-fluid px-0">
                <div class="video-content">
                    ...
                    <div class="video-img" style="background-image: url('{{ asset('front-assets/assets/img/video/01.jpg') }}');">
                        <div class="col-lg-6 mx-auto wow fadeInUp" data-wow-delay=".25s">
                            <div class="video-info">
                                ...
                                <p>There are many variations of passages available but the majority have suffered alteration in some form by injected humour words which don't look even slightly believable.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mx-auto">
                            <div class="site-heading text-center wow fadeInDown" data-wow-delay=".25s">
                                ...
                                <h2 class="site-title">How Our taxrio Works</h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="quote-form">
                                <form action="index-3.html#">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <button type="submit" class="theme-btn">Submit Now<i class="fas fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="choose-content-wrap">
                                <div class="choose-item">
                                    ...
                                    <div class="choose-item-info">
                                        ...
                                        <p>There are many variations of passages available the majority have suffered alteration in some by injected humour.</p>
                                    </div>
                                </div>
                                <div class="choose-item">
                                    <div class="choose-item-icon">
                        ...
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-info">
                                <div class="blog-item-meta">
                                    <ul>
                                        <li><a href="index-3.html#"><i class="far fa-user-circle"></i> By Alicia Davis</a></li>
