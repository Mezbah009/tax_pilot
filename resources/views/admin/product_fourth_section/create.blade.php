...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Create Product Fourth Section</h1>
            </div>
...
<section class="content">
    <form method="POST" action="{{ route('product_fourth_section.store', ['id' => $product->id]) }}"
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            success: function(response) {  // Fixed typo: 'function' instead of 'funtion'
                ...
                if(response["status"] == true){
                    window.location.href="{{ route('product_fourth_section.index', ['id' => $product->id]) }}"
