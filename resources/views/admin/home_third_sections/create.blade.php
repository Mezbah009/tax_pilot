...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Home Third Section</h1>
                </div>
    ...
    <section class="content">
        <form method="POST" action="{{ route('home-third-sections.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="container-fluid">
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('home-third-sections.create') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </div>
        </form>
    </section>
