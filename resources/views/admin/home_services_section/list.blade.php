...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Home Service Sections</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{route('home_services_section.create')}}" class="btn btn-primary">New Service</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <form action="" method="GET">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{route("home_services_section.index")}}'"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{asset('uploads/first_section/'.$section->icon)}}" class="img-thumbnail"
                            ...
                            <td>
                                <a href="{{route('home_services_section.edit',$section->id)}}">
...
<script>
    function destroySection(id){
            var url = '{{ route("home_services_section.delete", "ID") }}';
