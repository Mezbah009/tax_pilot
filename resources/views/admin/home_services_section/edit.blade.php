...
@section('content')
    ...
    <section class="content">
        <!-- Default box -->
        <form method="POST" action="{{ route('home_services_section.update', $section->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="summernote">{{ $section->description }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if ($section->icon)
                                        <div class="mt-2">
                                            <img src="{{ asset('uploads/first_section/' . $section->icon) }}"
                                                alt="Current Icon" width="100">
                                        </div>
                                    @endif
                                </div>
                            </div>
