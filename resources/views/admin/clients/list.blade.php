        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('clients.create') }}" class="btn btn-primary">New Product</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                            ...
                            @if ($sections->isNotEmpty())
                                @foreach ($sections as $section)
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($section->logo))
                                                <img src="{{ asset('uploads/first_section/' . $section->logo) }}"
                                                    class="img-thumbnail" alt="{{ $section->title }}" width="50">
                                            @else
                                        ...
                                        <td>{{ $section->link }}</td>
                                        <td>{{ $section->clientCategory->name ?? 'N/A' }}</td>
                                ...
                                @endif
                                        ...
                                        <td>
                                            <a href="{{ route('clients.edit', $section->id) }}">
                                            ...
                                            <a href="#" onclick="destroySection({{ $section->id }})"
