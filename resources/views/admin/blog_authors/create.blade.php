...
@section('content')
    ...
    <section class="content">
        <form method="POST" action="{{ route('blog_authors.store') }}" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="bio" id="bio" rows="5" class="summernote form-control"
                                        placeholder="Author biography..."></textarea>
                                </div>
                            </div>
