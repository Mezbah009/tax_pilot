...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Product first Sections</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href={{ route('product_first_section.create', ['id' => $product->id]) }}" class="btn btn-primary">New Product First
                    Section</a>
            ...
            <form action="" method="GET">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{route("product_first_section.index")}}'"
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('product_first_section.edit',$section->id)}}">
...
<script>
    function destroySection(id){
            var url = '{{ route("product_first_section.delete", "ID") }}';
