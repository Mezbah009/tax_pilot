                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="mission" id="mission" class="form-control" placeholder="Mission">{{ $section->mission }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="vision">Vision</label>
                                    <textarea type="text" name="vision" id="vision" class="form-control" placeholder="Vision">{{ $section->vision }}</textarea>
                                </div>
                            </div> --}}
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if (!empty($section->image))
                                        <div class="mt-2">
                                            <img src="{{ asset('uploads/first_section/' . $section->image) }}"
