    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('accreditation.create')}}" class="btn btn-primary">New Accreditation</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <form action="" method="GET">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{route("accreditation.index")}}'"
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('accreditation.edit',$section->id)}}">
...
<script>
    function destroySection(id){
            var url = '{{ route("accreditation.delete", "ID") }}';
