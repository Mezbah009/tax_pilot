...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Update Product Seventh Section</h1>
            </div>
...
<section class="content">
    <!-- Default box -->
    <form method="POST" action="{{ route('product_seventh_section.update', $section->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="link" id="link" class="form-control" placeholder="Link" value="{{ $section->link }}">
                                <p class="error"></p>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('product_seventh_section.index', ['id' => $section->product_id]) }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </div>
    </form>
