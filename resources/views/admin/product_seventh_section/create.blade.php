...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Create Product Seventh Section</h1>
            </div>
...
<section class="content">
    <form method="POST" action="{{ route('product_seventh_section.store', ['id' => $product->id]) }}" enctype="multipart/form-data">
        ...
        <div class="container-fluid">
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('product_seventh_section.create', ['id' => $product->id]) }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </div>
    </form>
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            success: function(response) {  // Fixed typo: 'function' instead of 'funtion'
                ...
                if(response["status"] == true){
                    window.location.href="{{ route('product_seventh_section.index', ['id' => $product->id]) }}"
